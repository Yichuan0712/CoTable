...
Specimen is the type of sample, such as 'Urine,' 'Plasma,' etc. **It must be a specific type of biological specimen.**
    - **BAD EXAMPLES (DO NOT USE AS Specimen):** "Birth (Mom)", "Birth (Cord)", "Birth (Infant)", etc. **These are sampling sources, NOT biological specimens. You should use something like "Plasma (Mom)", "Plasma (Infant)", "Plasma (Cord)" **  
