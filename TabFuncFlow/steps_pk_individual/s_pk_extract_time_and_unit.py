    ...
    while retries < max_retries:
        try:
            ...
            if df_table.shape[0] != expected_rows:
                messages = [msg,
                            "Wrong answer example:\n" + content + f"\nWhy it's wrong:\nMismatch: Expected {expected_rows} rows, but got {df_table.shape[0]} extracted matches. Think about why this happened, correct your approach, and try again with the right answer. Think about why this happened, correct your approach, and try again with the right answer."]
                raise ValueError(
