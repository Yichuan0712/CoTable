...
Additionally, I have compiled Subtable 2, where each row represents a unique combination of "Population" - "Pregnancy stage" - "Gestational/pediatric age" - "Subject N," as follows:
