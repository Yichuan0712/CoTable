...
If the PK parameter type is listed under a specific column (i.e., row headers are within a column), return <<the_col_name>>, replacing "the_col_name" with the actual column name.
