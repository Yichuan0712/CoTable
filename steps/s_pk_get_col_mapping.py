...
(2) **Important:** Any column referring to the **number of samples or subjects** must be classified under **"Uncategorized"** and **must not** be assigned to **"Parameter value."**  
